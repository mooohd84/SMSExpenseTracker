...
int _transactionEstimateSize(
  ...
  {
    final value = object.originalSmsBody;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
void _transactionSerialize(
  ...
  writer.writeString(offsets[4], object.originalSmsBody);
}
...
Transaction _transactionDeserialize(
  ...
  object.originalSmsBody = reader.readStringOrNull(offsets[4]);
  return object;
}
...
extension TransactionQuerySortBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByOriginalSmsBody() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQuerySortThenBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByOriginalSmsBody() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'originalSmsBody', Sort.asc);
    });
  }
...
extension TransactionQueryWhereDistinct
  ...
  QueryBuilder<Transaction, Transaction, QDistinct> distinctByOriginalSmsBody(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
